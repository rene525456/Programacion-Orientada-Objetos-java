 ...
 * @author rene
 */
public class FrmBorderDeber extends javax.swing.JFrame {

    /**
     * Creates new form FrmDeber
     */
    public FrmBorderDeber() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBorderDeber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBorderDeber().setVisible(true);
            }
        });
    }
