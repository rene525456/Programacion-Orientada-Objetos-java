 ...
 * @author rene
 */
public class FrmGridBagLayout extends javax.swing.JFrame {

    /**
     * Creates new form FrmGridBagLayout
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGridBagLayout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmGridBagLayout().setVisible(true);
            }
        });
    }
