...
public class FrmLibro extends javax.swing.JFrame {
    ...
    LibroModeloTabla modelo;
    int fila = -1;
    
    public FrmLibro() {
        initComponents();
        dao = new LibroImplementacion();     
        modelo = new LibroModeloTabla(dao.listarTodos());
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Lista de Libros Agregados");
        jPanel2.add(jLabel6);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String clasificación = txtClasificacion.getText();
        int anio = Integer.parseInt(spinerAnio.getValue().toString());
        
        Libro libro = new Libro(ISBN, clasificación, titulo, anio);
        

        if (dao.guardar(libro)){
